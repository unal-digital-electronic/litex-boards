...
# ./colorlight_5a_75e.py --revision=7.0 (or 6.1) (--with-ethernet to add Ethernet capability)
# Note: on revision 6.1, add --uart-baudrate=9600 to lower the baudrate.
# ./colorlight_5a_75e.py --load
# You should see the LiteX BIOS and be able to interact with it.
#
# 2) SoC with UART in crossover mode over Etherbone:
# ./colorlight_5a_75e.py --revision=7.1 --uart-name=crossover --with-etherbone --csr-csv=csr.csv
# ./colorlight_5a_75e.py --load
# ping 192.168.1.50
...
# ./colorlight_5a_75e.py --revision=7.0 --uart-name=usb_acm
# ./colorlight_5a_75e.py --load
# You should see the LiteX BIOS and be able to interact with it.
#
